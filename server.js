...
// Cache em memória: key → array de {t, e}
...
async function initEmbedder() {
  // Pré-carrega embeddings em background (sem bloquear o start)
...
app.post('/chat', async (req, res) => {
  ...
  try {
    ...
    if (isNew) {
      ...
      // Legado: app já enviou system completo com trechos
